...
export const Mundomascotas = () => {
  ...
  return (
    ...
    <>
      <Box>
        <Box bg={`url(${perros})`} backgroundPosition='center' position='relative' justifyContent='center' height='500px' width='100%' backgroundRepeat='no-repeat' backgroundSize='cover'>
