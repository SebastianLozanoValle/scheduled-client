    ...
    return (
        <div className="xs:w-full sm:w-full py-10 flex flex-col gap-4">
            <div className="w-full">
                ...
                <InputFormField mitad={false} defaultValue={values.confirmpassword} register={register} label="ConfirmeContraseña" id="confirmpassword" placeholder="ConfirmeContraseña" type="password" required={true} errors={errors} validation={{ required: true, validate: value => value === watch('password') || "The passwords do not match" }} />
            </div>
